...
from simulation import simulation, parallel_solve, rl_solve
...
def parse_arguments():
    ...
    parser.add_argument("--solver", type=str, default="rl", help="solver for optimization")
...
if __name__ == "__main__":
    ...
    file_name = ".".join([args.solver, str(args.seed), args.task.split("-")[0], "txt"])
    if args.mode == "random":
